...
# vblake@agent511.com
version = '9/24/18-3'
# wrtcr.py  - demo script to show WebRTC session invite via http (hosted) html refer page sent via SMS and URL for TC
#           - this version adds RESTful support
#           - /ecreate/<r_mdn> adds the mdn from restful url instead of GUI
...
def ecreate(r_mdn):
  global mdn
  mdn = r_mdn
  print ("WRTCH: MDN is " + mdn)
  return ("WRTCH: MDN is " + mdn)
...
def einvite():
  ...
  body="&body=Click on this link to share audio and video: "
